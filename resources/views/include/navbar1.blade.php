        ...
        <li class="nav-item nav-profile dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
            <a class="dropdown-item">
			  ...
			  <li class="nav-item active"><a href="{{URL::to('/logout_admin')}}" class="nav-link">Déconnexion</a></li>
			  @else
			  <li class="nav-item active"><a href="{{URL::to('/admin_login')}}" class="nav-link">Connexion</a></li>
			  @endif
            </a>
          </div>
        </li>
