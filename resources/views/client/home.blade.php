...
@section('contenu')
	  ...
	  <section id="home-section" class="hero">
		  <div class="home-slider owl-carousel">
			 ...
			 <div class="slider-item" style="background-image: url(../public/storage/slider_images/{{$slider->slider_image}});">
				<div class="overlay"></div>
			  <div class="container">
				<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
	
				  <div class="col-md-12 ftco-animate text-center">
					<h1 class="mb-2">{{$slider->description01}}</h1>
					<h2 class="subheading mb-4">{{$slider->description02}} &amp; fruits</h2>
	...
	<section class="ftco-section">
		...
		<div class="container">
			<div class="row">
				...
				<div class="product">
					<a href="#" class="img-prod"><img class="img-fluid" src="../public/storage/product_images/{{$produit->product_image}}" alt="Colorlib Template">
						<div class="overlay"></div>
					</a>
					<div class="text py-3 pb-4 px-3 text-center">
						...
						<div class="d-flex">
							<div class="pricing">
								<p class="price"><span class="price-sale">{{$produit->product_price}} DA</span></p>
							</div>
						</div>
		...
		<div class="container">
		  ...
		  <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
			...
			{{--<h2 class="mb-4">Affaire du jour</h2>
			<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia</p>
