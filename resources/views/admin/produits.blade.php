              ...
              <div class="table-responsive">
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$increment}}</td>
                      <td><img src="../public/storage/product_images/{{$produit->product_image}}" alt=""></td>
                      ...
                      <td>
                          ...
                          @else
                          <button class="btn btn-outline-secondary" onclick="window.location='{{url('/activer_produit/'.$produit->id)}}'">Activer</button> 
                          @endif
                      </td> 
                  </tr>
