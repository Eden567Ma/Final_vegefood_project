                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img src="../public/storage/product_images/<?php echo e($produit->product_image); ?>" alt=""></td>
                      ...
                      <td>
                          ...
                          <?php else: ?>
                          <button class="btn btn-outline-secondary" onclick="window.location='<?php echo e(url('/activer_produit/'.$produit->id)); ?>'">Activer</button> 
                          <?php endif; ?>
                      </td> 
                  </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Biofood\resources\views/admin/produits.blade.php ENDPATH**/ ?>