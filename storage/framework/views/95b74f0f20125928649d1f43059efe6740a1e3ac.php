	...
	<?php endif; ?>
		<div class="container-login100" style="background-image: url('login/images/bg-02.jpg');">
			<div class="wrap-login100">
				<form action="<?php echo e(url('/creer_compte_admin')); ?>" method="POST" class="login100-form validate-form">
					...
					<div class="text-center p-t-90">
						<a class="txt1" href="<?php echo e(URL::to('/admin_login')); ?>">
...
</html><?php /**PATH C:\wamp64\www\Biofood\resources\views/admin/signup.blade.php ENDPATH**/ ?>