	...
	<div class="container">
	  <div class="row justify-content-center">
		<div class="col-xl-7 ftco-animate">
			            <form action="<?php echo e(url('/payer')); ?>" method="POST" id="checkout-form" class="billing-form">
				...
				<div class="col-md-12 d-flex mb-5">
					<div class="cart-detail cart-total p-3 p-md-4">
						...
						<p class="d-flex">
								  ...
								  <span><?php echo e(Session::get('cart')->totalPrice); ?> DA</span>
							  </p>
							  <p class="d-flex">
								  <span>Livraison</span>
								  <span>10 DA</span>
							  ...
							  <p class="d-flex total-price">
								  <span>Total</span>
								  <span><?php echo e(Session::get('cart')->totalPrice +10); ?> DA</span>
							  </p>
							  </div>
				</div>
...
<?php $__env->stopSection(); ?>
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Biofood\resources\views/client/checkout.blade.php ENDPATH**/ ?>