                ...
                <table id="order-listing" class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                          <button class="btn btn-outline-primary" onclick="window.location='<?php echo e(url('/voir_pdf/'.$order->id)); ?>'">Voir</button>
                      </td> 
                  </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.appadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Biofood\resources\views/admin/commandes.blade.php ENDPATH**/ ?>